          ...
          <ul>
             <li>
                <div class="tpcart__item">
                   ...
                   <div class="tpcart__content">
                      <span class="tpcart__content-title"><a href="{{url('detail')}}">Miko Wooden Bluetooth Speaker</a>
                      </span>
             ...
             <li>
                <div class="tpcart__item">
                   ...
                   <div class="tpcart__content">
                      <span class="tpcart__content-title"><a href="{{url('detail')}}">Evo Lightweight Granite Shirt</a>
                      </span>
                      <div class="tpcart__cart-price">
                         <span class="quantity">1 x</span>
